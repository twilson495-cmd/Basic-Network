...
![Router Gi0/0 config](images/02-router-gi0-0-config.png)
...
![Router Gi0/1 config](images/03-router-gi0-1-config.png)
...
![PC IP configuration](images/04-pc-ip-config.png)
